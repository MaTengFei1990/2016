...
//    String SERVER_ROOT="http://10.0.2.2:8080/FuLiCenterServer/Server";
	...
	String AVATAR_PATH 								= 		"//D:/Timeviry/superwechatDB-20160518/superwechatDB";
	String ISON8859_1 								= 		"iso8859-1";
	String UTF_8 									= 		"utf-8";
	String PAGE_ID 									= 		"page_id";						//分页的起始下标
	String PAGE_SIZE 								= 		"page_size";					//分页的每页数量
	int  PAGE_ID_DEFULT 							= 		0;								//分页的起始下标默认值
	int PAGE_SIZE_DEFULT 						    = 		20;								//分页的每页数量默认值
	...
	String MSG_PREFIX_MSG							=		"msg_";							//返回消息的前缀
    ...
    String ACTION_TRPE_CART = "cart";
    String ACTION_TRPE_PERSON = "person";
