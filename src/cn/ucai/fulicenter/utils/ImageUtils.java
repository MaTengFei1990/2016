...
//	}
	...
	* 获得头像的地址*/
	...
	public static void setNewGoodThunb(String goodsThumb, NetworkImageView nivThumb) {
	...
	public static void setGoodDetailThunb(String colorImg, NetworkImageView imageView) {

		String url = FuLiCenterApplication.SERVER_ROOT
				+ "?" + I.KEY_REQUEST + "=" + I.REQUEST_DOWNLOAD_COLOR_IMG
				+ "&" + I.Color.COLOR_IMG +"=" + colorImg;
		setThunb(url, imageView);

	}
	public static void setThunb(String url, NetworkImageView imageView) {
